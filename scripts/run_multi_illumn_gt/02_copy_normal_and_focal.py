...
def create_argparser():    
    ...
    parser.add_argument("--input_dir", type=str, default="/ist/ist-share/vision/pakkapon/relight/DiffusionLight-SingleLoRA/output_t1/multi_illumination/real/test")
    parser.add_argument("--output_dir", type=str, default="/pure/t1/output/DiffusionLight-LoRASwapping/multi_illumination/test/seed100")

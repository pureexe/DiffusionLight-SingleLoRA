...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', type=str, default="/ist/ist-share/vision/pakkapon/relight/DiffusionLight-SingleLoRA/output/multi_illumination/least_square/val", help='input dir')
    parser.add_argument('--output_dir', type=str, default="/ist/ist-share/vision/pakkapon/relight/DiffusionLight-SingleLoRA/output/multi_illumination/least_square/val", help='output dir')
    ...
    parser.add_argument('--shading_dir', type=str, default="shading_exr_perspective_v3_order6_marigold", help='template for output dir')
    parser.add_argument('--vizmax_dir', type=str, default="shading_exr_perspective_v3_order6_marigold_viz_max", help='template for vizmax dir')
    parser.add_argument('--vizldr_dir', type=str, default="shading_exr_perspective_v3_order6_marigold_viz_ldr", help='template for vizldr dir')

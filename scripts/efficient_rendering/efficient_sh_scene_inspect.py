...
if __name__ == "__main__":
    ...
    parser.add_argument('--focal_dir_template', type=str, default="/ist/ist-share/vision/pakkapon/relight/DiffusionLight-SingleLoRA/output/scene_inspect/14n_copyroom1/{}/focal", help='template for coeff dir')
    parser.add_argument('--coeff_dir_template', type=str, default="/ist/ist-share/vision/pakkapon/relight/DiffusionLight-SingleLoRA/output/scene_inspect/14n_copyroom1/{}/shcoeff_perspective_v3_order100_gt", help='template for coeff dir')
    parser.add_argument('--normal_dir_template', type=str, default="/ist/ist-share/vision/pakkapon/relight/DiffusionLight-SingleLoRA/output/scene_inspect/14n_copyroom1/{}/normal", help='template for normal dir')
    parser.add_argument('--output_dir_template', type=str, default="/ist/ist-share/vision/pakkapon/relight/DiffusionLight-SingleLoRA/output/scene_inspect/14n_copyroom1/{}/fix_banding/shading_exr_perspective_v3_order10_gt_ball", help='template for output dir')
    parser.add_argument('--vizmax_dir_template', type=str, default="/ist/ist-share/vision/pakkapon/relight/DiffusionLight-SingleLoRA/output/scene_inspect/14n_copyroom1/{}/fix_banding/shading_exr_perspective_v3_order10_gt_ball_vizldr", help='template for vizmax dir')
    parser.add_argument('--vizldr_dir_template', type=str, default="/ist/ist-share/vision/pakkapon/relight/DiffusionLight-SingleLoRA/output/scene_inspect/14n_copyroom1/{}/fix_banding/shading_exr_perspective_v3_order10_gt_ball_vizmax", help='template for vizldr dir')
    parser.add_argument('--total_scene', type=int, default=1)

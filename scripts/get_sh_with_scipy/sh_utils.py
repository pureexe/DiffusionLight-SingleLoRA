...
def sample_from_sh_numpy(shcoeff, lmax, theta, phi):
    ...
    for ch in range(3):
        ...
        output[:, ch] = acc
    output = output.reshape(*shape, 3).astype(np.float32)
    return output

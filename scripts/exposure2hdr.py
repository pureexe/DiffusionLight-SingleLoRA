...
def process_image(args, info):
    ...
    # inital first image
    image0_path = os.path.join(args.input_dir, files[0])
    try:
        image0 = skimage.io.imread(image0_path)[...,:3]
    except:
        print("Failed to read: ",image0_path)
        return None
    ...
    if args.preview_output:
        ...
        skimage.io.imsave(preview_path, skimage.img_as_ubyte(bracket))
        os.chmod(preview_path, 0o777)
    return None

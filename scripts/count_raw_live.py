...
TOTAL_SCENE = 816
TEMPLATE = "/ist/ist-share/vision/pakkapon/relight/DiffusionLight-SingleLoRA/output/laion-aesthetics-1024/{}/raw"
...
def count_files():
    ...
    for scene_id in range(TOTAL_SCENE):
        ...
        try:
            ...
            continue
        exr_files = [f for f in files if f.endswith("_ev-00.png")]
        count += len(exr_files)
    return count

...
OUTPUT_DIR = "/ist/ist-share/vision/pakkapon/relight/DiffusionLight-SingleLoRA/output/laion-aesthetics-1024/{}/envmap"
...
def main():
    ...
    for scene_id in scene_ids:
        ...
        if not os.path.exists(in_dir):
            ...
            continue
        cmd = f"python ball2envmap.py --ball_dir {in_dir} --envmap_dir {out_dir}"
        print(cmd)
        os.system(cmd)
